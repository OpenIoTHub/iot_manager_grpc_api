...
import 'hostManager.pb.dart' as $3;
export 'hostManager.pb.dart';

class HostManagerClient extends $grpc.Client {
  static final _$getAllHosts = $grpc.ClientMethod<$0.Empty, $3.HostInfoList>(
      '/pb.HostManager/GetAllHosts',
      ($0.Empty value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $3.HostInfoList.fromBuffer(value));
  static final _$addOrUpdateHost =
      $grpc.ClientMethod<$3.HostInfo, $0.OperationResponse>(
          '/pb.HostManager/AddOrUpdateHost',
          ($3.HostInfo value) => value.writeToBuffer(),
  ...
  $grpc.ResponseFuture<$3.HostInfoList> getAllHosts($0.Empty request,
  ...
  $grpc.ResponseFuture<$0.OperationResponse> delHost($3.HostInfo request,
      {$grpc.CallOptions options}) {
...
abstract class HostManagerServiceBase extends $grpc.Service {
  ...
  HostManagerServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.Empty, $3.HostInfoList>(
        'GetAllHosts',
        getAllHosts_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.Empty.fromBuffer(value),
        ($3.HostInfoList value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$3.HostInfo, $0.OperationResponse>(
        'AddOrUpdateHost',
        addOrUpdateHost_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $3.HostInfo.fromBuffer(value),
  ...
  $async.Future<$3.HostInfoList> getAllHosts_Pre(
      $grpc.ServiceCall call, $async.Future<$0.Empty> request) async {
    return getAllHosts(call, await request);
  }

  $async.Future<$0.OperationResponse> addOrUpdateHost_Pre(
      $grpc.ServiceCall call, $async.Future<$3.HostInfo> request) async {
  ...
  $async.Future<$3.HostInfoList> getAllHosts(
      $grpc.ServiceCall call, $0.Empty request);
  $async.Future<$0.OperationResponse> addOrUpdateHost(
      $grpc.ServiceCall call, $3.HostInfo request);
