...
var file_gatewayManager_proto_rawDesc = []byte{
	...
	0x65, 0x77, 0x61, 0x79, 0x49, 0x6e, 0x66, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x32, 0xe7, 0x02, 0x0a,
...
var file_gatewayManager_proto_depIdxs = []int32{
	...
	3, // 7: pb.GatewayManager.AddGateway:output_type -> pb.OperationResponse
	3, // 8: pb.GatewayManager.DelGateway:output_type -> pb.OperationResponse
	3, // 9: pb.GatewayManager.UpdateGateway:output_type -> pb.OperationResponse
	0, // 10: pb.GatewayManager.QueryGateway:output_type -> pb.GatewayInfo
	1, // 11: pb.GatewayManager.GetAllGateway:output_type -> pb.GatewayInfoList
	0, // 12: pb.GatewayManager.GenerateOneGatewayWithDefaultServer:output_type -> pb.GatewayInfo
