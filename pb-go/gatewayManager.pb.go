...
var file_gatewayManager_proto_rawDesc = []byte{
	...
	0x65, 0x77, 0x61, 0x79, 0x49, 0x6e, 0x66, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x32, 0xf1, 0x03, 0x0a,
	...
	0x49, 0x6e, 0x66, 0x6f, 0x22, 0x00, 0x12, 0x46, 0x0a, 0x20, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61,
	0x74, 0x65, 0x4f, 0x6e, 0x65, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x57, 0x69, 0x74, 0x68,
	0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x55, 0x75, 0x69, 0x64, 0x12, 0x0f, 0x2e, 0x70, 0x62, 0x2e,
	0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x1a, 0x0f, 0x2e, 0x70, 0x62,
	0x2e, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x00, 0x12, 0x40,
	0x0a, 0x1a, 0x47, 0x65, 0x74, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x4a, 0x77, 0x74, 0x42,
	0x79, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x55, 0x75, 0x69, 0x64, 0x12, 0x0f, 0x2e, 0x70,
...
var file_gatewayManager_proto_depIdxs = []int32{
	...
	3, // 7: pb.GatewayManager.GenerateOneGatewayWithServerUuid:input_type -> pb.StringValue
	3, // 8: pb.GatewayManager.GetGatewayJwtByGatewayUuid:input_type -> pb.StringValue
	4, // 9: pb.GatewayManager.AddGateway:output_type -> pb.OperationResponse
	4, // 10: pb.GatewayManager.DelGateway:output_type -> pb.OperationResponse
	4, // 11: pb.GatewayManager.UpdateGateway:output_type -> pb.OperationResponse
	0, // 12: pb.GatewayManager.QueryGateway:output_type -> pb.GatewayInfo
	1, // 13: pb.GatewayManager.GetAllGateway:output_type -> pb.GatewayInfoList
	0, // 14: pb.GatewayManager.GenerateOneGatewayWithDefaultServer:output_type -> pb.GatewayInfo
	0, // 15: pb.GatewayManager.GenerateOneGatewayWithServerUuid:output_type -> pb.GatewayInfo
	3, // 16: pb.GatewayManager.GetGatewayJwtByGatewayUuid:output_type -> pb.StringValue
