...
var file_mqttDeviceManager_proto_rawDesc = []byte{
	...
	0x4c, 0x69, 0x73, 0x74, 0x32, 0x88, 0x02, 0x0a, 0x11, 0x4d, 0x71, 0x74, 0x74, 0x44, 0x65, 0x76,
	...
	0x3e, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x4d, 0x71, 0x74, 0x74, 0x44, 0x65, 0x76,
	0x69, 0x63, 0x65, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x12, 0x09, 0x2e, 0x70, 0x62, 0x2e, 0x45,
	0x6d, 0x70, 0x74, 0x79, 0x1a, 0x17, 0x2e, 0x70, 0x62, 0x2e, 0x4d, 0x71, 0x74, 0x74, 0x44, 0x65,
	0x76, 0x69, 0x63, 0x65, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x00, 0x42,
...
var file_mqttDeviceManager_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_mqttDeviceManager_proto_depIdxs = []int32{
	...
	4, // 4: pb.MqttDeviceManager.GetAllMqttDevice:input_type -> pb.Empty
	4, // 5: pb.MqttDeviceManager.GetAllMqttDeviceModels:input_type -> pb.Empty
	5, // 6: pb.MqttDeviceManager.AddMqttDevice:output_type -> pb.OperationResponse
	5, // 7: pb.MqttDeviceManager.DelMqttDevice:output_type -> pb.OperationResponse
	1, // 8: pb.MqttDeviceManager.GetAllMqttDevice:output_type -> pb.MqttDeviceInfoList
	3, // 9: pb.MqttDeviceManager.GetAllMqttDeviceModels:output_type -> pb.MqttDeviceModelList
