...
type PortInfo struct {
	...
	HostUUID            int64  `protobuf:"varint,10,opt,name=HostUUID,proto3" json:"HostUUID,omitempty"`
}
...
var file_portManager_proto_rawDesc = []byte{
	...
	0x49, 0x44, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x48, 0x6f, 0x73, 0x74, 0x55, 0x55,
	0x49, 0x44, 0x32, 0xd4, 0x01, 0x0a, 0x0b, 0x50, 0x6f, 0x72, 0x74, 0x4d, 0x61, 0x6e, 0x61, 0x67,
...
var file_portManager_proto_depIdxs = []int32{
	...
	0, // 5: pb.PortManager.GetAllPorts:output_type -> pb.PortInfoList
	3, // 6: pb.PortManager.AddPort:output_type -> pb.OperationResponse
	3, // 7: pb.PortManager.UpdatePort:output_type -> pb.OperationResponse
	3, // 8: pb.PortManager.DelPort:output_type -> pb.OperationResponse
